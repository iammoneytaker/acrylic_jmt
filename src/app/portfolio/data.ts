  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        name: '성수 미미달 팝업',
        description:
          '한국 전통의 디자인 브랜드인 미미달의 성수 팝업의 인테리어를 아크릴을 활용해서 제작하고 시공한 사례입니다. 전통적인 느낌과 아크릴의 모던함이 만나는 경험을 하게 해주신 미미달 대표님에게 감사드립니다. 아래에는 나무 선반 또한 직접 제작하여 설치하였습니다.',
      },
      {
        no: 5,
        name: '스탬프투어 포맥스 안내판',
        description:
          '포맥스와 UV인쇄를 활용해서 스탬프투어의 안내판을 제작한 사례입니다. K-플라워 굿 페스타의 행사에 참여한 사람들이 스탬프 투어를 즐길 수 있게 안내판을 제작했습니다.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        name: '아크릴 야구공 전시장',
        description:
          '청담리온정형외과에 오는 다양한 야구선수분들의 싸인볼을 전시할 수 있는 전시장을 아크릴로 제작하고 아래에 나무선반을 제작해서 시공까지 한 사례입니다. 정말 다양한 야구 선수들의 싸인볼을 전시할 수 있는 기회가 생겨서 좋았습니다.',
      },
    ],
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        name: '아크릴 우편함',
        description:
          '평범한 우편함은 철 소재를 이용해서 만들지만 이번에는 아크릴로 대형 우편함을 만들어 달라는 요청이 와서 제작한 사례입니다. 2개의 색상을 섞어서 제작했습니다. 생각보다 더욱 이쁘게 나와서 다행이었습니다.',
      },
    ],
  },
  // ... 다른 카테고리들 ...
